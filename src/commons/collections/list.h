...
#define LIST_H_
	...
	*
	* @param self Lista a destruir
	* @param element_destroyer Función que libera la memoria de cada elemento
	*
	* @relates t_list
	*/
	...
	*
	* @param self Lista a la que se le agregará el elemento
	* @param element Puntero al elemento a agregar
	*
	...
	*
	* @param self Lista a la que se le agregará el elemento
	* @param index Posición en la que se agregará el elemento
	* @param element Puntero al elemento a agregar
	*
	* @relates t_list
	*/
	...
	* @param comparator Función que compara dos elementos
	*
	...
	*
	* @param self Lista a la que se le agregarán los elementos
	* @param other Lista de la que se tomarán los elementos
	*
	* @relates t_list
	*/
	...
	*
	* @param self Lista de la que se obtendrá el elemento
	* @param index Posición del elemento a obtener
	*
	* @return Puntero al elemento guardado en la posición index
	*
	* @relates t_list
	*/
	...
	*
	* @param self Lista de la que se obtendrá el mínimo
	* @param minimum Función que compara dos elementos y devuelve el mínimo entre ellos
	*
	* @relates t_list
	*/
	...
	*
	* @param self Lista de la que se obtendrá el máximo
	* @param maximum Función que compara dos elementos y devuelve el máximo entre ellos
	*
	* @relates t_list
	*/
	...
	*
	* @param self Lista de la que se tomarán los elementos
	* @param count Cantidad de elementos a tomar
	*
	* @return Lista con los primeros n elementos
	*
	* @relates t_list
	*/
	...
	*
	* @param self Lista de la que se tomarán los elementos
	* @param start Índice desde el que se tomarán los elementos
	* @param count Cantidad de elementos a tomar
	*
	* @return Lista con los primeros n elementos partiendo desde el índice indicado
	*
	* @relates t_list
	*/
	...
	* @param count Cantidad de elementos a tomar
	*
	* @return Lista con los primeros elementos extraídos
	*
	* @relates t_list
	*/
